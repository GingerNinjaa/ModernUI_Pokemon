...
namespace ModernUI {
    ...
    public partial class CompanyDBDataSet : global::System.Data.DataSet {
        ...
        public partial class tblProductsDataTable : global::System.Data.TypedTableBase<tblProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tblProductsRow AddtblProductsRow(string ProductId, string Name, string Description, decimal Price, string CategoryName, string ImageName, string QRCode) {
    ...
    public partial class tblProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblProducts] WHERE (([ProductId] = @Original_ProductId) AND ((" +
                "@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ([Cat" +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tblProducts] ([ProductId], [Name], [Description], [Price], [CategoryName], [ImageName], [QRCode]) VALUES (@ProductId, @Name, @Description, @Price, @CategoryName, @ImageName, @QRCode);
SELECT ProductId, Name, Description, Price, CategoryName, CategoryId, ImageName, QRCode FROM tblProducts WHERE (ProductId = @ProductId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblProducts] SET [ProductId] = @ProductId, [Name] = @Name, [Description] = @Description, [Price] = @Price, [CategoryName] = @CategoryName, [ImageName] = @ImageName, [QRCode] = @QRCode WHERE (([ProductId] = @Original_ProductId) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ([CategoryId] = @Original_CategoryId));
SELECT ProductId, Name, Description, Price, CategoryName, CategoryId, ImageName, QRCode FROM tblProducts WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ModernUI.Properties.Settings.Default.CompanyDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, Name, Description, Price, CategoryName, CategoryId, ImageName, " +
                "QRCode FROM dbo.tblProducts";
        ...
        public virtual int Delete(string Original_ProductId, global::System.Nullable<decimal> Original_Price, int Original_CategoryId) {
        ...
        public virtual int Insert(string ProductId, string Name, string Description, global::System.Nullable<decimal> Price, string CategoryName, string ImageName, string QRCode) {
            if ((ProductId == null)) {
            ...
            if ((QRCode == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(QRCode));
            }
        ...
        public virtual int Update(string ProductId, string Name, string Description, global::System.Nullable<decimal> Price, string CategoryName, string ImageName, string QRCode, string Original_ProductId, global::System.Nullable<decimal> Original_Price, int Original_CategoryId) {
            if ((ProductId == null)) {
                throw new global::System.ArgumentNullException("ProductId");
            }
            else {
            ...
            if ((QRCode == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(QRCode));
            }
            if ((Original_ProductId == null)) {
                throw new global::System.ArgumentNullException("Original_ProductId");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, global::System.Nullable<decimal> Price, string CategoryName, string ImageName, string QRCode, string Original_ProductId, global::System.Nullable<decimal> Original_Price, int Original_CategoryId) {
            return this.Update(Original_ProductId, Name, Description, Price, CategoryName, ImageName, QRCode, Original_ProductId, Original_Price, Original_CategoryId);
        }
    }
